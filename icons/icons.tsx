...
export function MongoLeaf(props: SVGProps<SVGSVGElement>) {
  return (
    <svg width="1em" height="1em" viewBox="0 0 32 32" {...props}>
      <defs>
        <linearGradient
          id="IconifyId1806699936664b3d518"
          x1="-645.732"
          x2="-654.59"
          y1="839.188"
          y2="839.25"
        ...
        <linearGradient
          id="IconifyId1806699936664b3d519"
          x1="-644.287"
          x2="-657.028"
          y1="823.405"
          y2="845.476"
        ...
        <linearGradient
          id="IconifyId1806699936664b3d520"
          x1="-643.386"
          x2="-652.418"
          y1="839.485"
          y2="833.417"
      ...
      <path
        fill="url(#IconifyId1806699936664b3d518)"
      ...
      ></path>
      <path
        fill="url(#IconifyId1806699936664b3d519)"
      ...
      ></path>
      <path
        fill="url(#IconifyId1806699936664b3d520)"
...
export function Logo(props: SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      ...
      />
      <g
        transform="matrix(.81156 0 0 .81156 1.5075 .56533)"
        fill="currentColor"
      >
...
export function Pwa(props: SVGProps<SVGSVGElement>) {
  return (
    <svg width="2.66em" height="1em" viewBox="0 0 512 193" {...props}>
      <path
        fill="currentColor"
...
export function Computer(props: SVGProps<SVGSVGElement>) {
  return (
    <svg width="1em" height="1em" viewBox="0 0 64 64" {...props}>
      ...
      ></path>
      <g fill="#243438">
        <path d="M63.784 36.941c0 4.04-3.05 7.32-6.806 7.32H6.848c-3.76 0-6.809-3.277-6.809-7.32V10.163c0-4.047 3.049-7.325 6.809-7.325h50.13c3.756 0 6.806 3.278 6.806 7.325v26.778"></path>
        <path d="M.036 35.05h63.749v11.367H.036z"></path>
      </g>
      <path
        fill="#58c5e8"
  ...
  return (
    ...
    >
      <g transform="matrix(-1,0,0,1,62,-2)">
        <path
          d="m31.4 31.4-0.5-6.3-3.4 0.3 0.5 5.5-9.4 4.4 3.8 3s2.7-1.1 2.5-2l5.7-3.1c0.7-0.3 1-1.1 0.8-1.8"
          fill="#231f20"
        />
        <path
          d="m57 35.2-16.2 10.2 0.9 1.2 16.9-8.1c0-1.2-0.5-2.5-1.6-3.3"
          fill="#e6e6e6"
        />
        <g fill="#3e4347">
          <path d="m40.1 44.7 4.8-2.3s2.2 1.9-0.2 4.1l-4.6-1.8m-28.7-1.5c-5.2 0-9.4 4.2-9.4 9.4s4.2 9.4 9.4 9.4 9.4-4.2 9.4-9.4-4.2-9.4-9.4-9.4m0 16c-3.6 0-6.6-2.9-6.6-6.6 0-3.6 2.9-6.6 6.6-6.6 3.6 0 6.6 2.9 6.6 6.6-0.1 3.7-3 6.6-6.6 6.6" />
          <path d="m18.4 52.2-4.3-0.3 3.6-2.4-0.5-0.8-3.8 1.9 1.8-3.9-0.7-0.4-2.4 3.5-0.3-4.2h-0.9l-0.3 4.2-2.3-3.5-0.8 0.5 1.8 3.8-3.8-1.8-0.4 0.7 3.5 2.4-4.3 0.3v0.9l4.3 0.3-3.5 2.3 0.4 0.8 3.8-1.8-1.8 3.8 0.8 0.4 2.3-3.5 0.4 4.3h0.8l0.3-4.3 2.4 3.5 0.8-0.4-1.9-3.8 3.8 1.8 0.5-0.8-3.5-2.3 4.2-0.3z" />
        </g>
        <path
          d="m11.4 47.9c-2.6 0-4.7 2.1-4.7 4.7s2.1 4.7 4.7 4.7 4.7-2.1 4.7-4.7-2.1-4.7-4.7-4.7m0 7.5c-1.6 0-2.8-1.3-2.8-2.8s1.3-2.8 2.8-2.8c1.6 0 2.8 1.3 2.8 2.8s-1.3 2.8-2.8 2.8"
          fill="#e6e6e6"
        />
        <path d="m35.8 42.1v6.3l16.4 6.9 1.8-5z" fill="#94989b" />
        <path
          d="m52.6 43.2c-5.2 0-9.4 4.2-9.4 9.4s4.2 9.4 9.4 9.4 9.4-4.2 9.4-9.4-4.2-9.4-9.4-9.4m0 16c-3.6 0-6.6-2.9-6.6-6.6 0-3.6 2.9-6.6 6.6-6.6 3.6 0 6.6 2.9 6.6 6.6s-3 6.6-6.6 6.6"
          fill="#3e4347"
        />
        <path
          ...
          fill="#94989b"
        />
        <path d="m28.4 40.3 22.4-7.3 0.9 5.3-19.6 9.6z" fill="#3e4347" />
        <path
          d="m27.7 40.8 0.2-2.7c0-0.5 0.5-0.9 1-1.1 1.5-0.5 5.9-2.2 5.9-2.2l2.8 3.5-9.9 2.5"
          fill="#ed4c5c"
        />
        <path d="m11.4 53.3 8.3-11.9-2.5-1.9-6.4 13.1z" fill="#3e4347" />
        <path
          d="m19.4 46.2c-1.9-2.4-4.8-3.9-8-3.9-2.5 0-4.8 0.9-6.5 2.3l14.5 1.6"
          fill="#c94747"
        />
        <path
          d="m59.7 52.2-4.3-0.3 3.5-2.4-0.4-0.8-3.9 1.9 1.9-3.9-0.8-0.4-2.3 3.5-0.3-4.2h-0.9l-0.3 4.2-2.4-3.5-0.8 0.5 1.9 3.8-3.9-1.8-0.4 0.7 3.6 2.4-4.3 0.3v0.9l4.2 0.3-3.5 2.3 0.5 0.8 3.8-1.8-1.9 3.8 0.8 0.4 2.4-3.5 0.3 4.3h0.9l0.3-4.3 2.4 3.5 0.7-0.4-1.8-3.8 3.8 1.8 0.4-0.8-3.5-2.3 4.3-0.3z"
          fill="#3e4347"
        />
        <path
          d="m52.6 47.9c-2.6 0-4.7 2.1-4.7 4.7s2.1 4.7 4.7 4.7 4.7-2.1 4.7-4.7-2.1-4.7-4.7-4.7m0 7.5c-1.6 0-2.8-1.3-2.8-2.8s1.3-2.8 2.8-2.8 2.8 1.3 2.8 2.8-1.2 2.8-2.8 2.8"
          fill="#e6e6e6"
        />
        <path
          d="m44.9 38.4c-1.7 0.8-1.6 2.4-1.6 2.4s5.2-0.3 11.8-3.9c3.2-1.8 3.2-5.6 3.2-5.6-11.4-0.2-8.1 4.4-13.4 7.1m-3.1 9.3c-5.1 0-5.5-4.5-10.3-6.3-6-2.3-14.8-3.3-16.4-3.3-1.7 0-0.4-1.9 0-2.4 3.4-4 7.8-3.3 7.8-3.3l-1.4-1.3c-4.2 0-7.9 2.1-10.1 5.3-0.9 1.3-2.3 3.1-1.5 3.6 2 1.4 8.1 5.4 8.1 5.4s2.4 1.6 2.8 2.4c0.9 1.6 1 8 1 8 0 0.7 0.5 1.4 1.4 1.3l18.4-2.5c-0.5-1.3-0.8-3.6 0.2-6.9"
          fill="#ed4c5c"
        />
        <path d="m11.4 39h2.5l-0.8 2s-3.6-2-1.7-2" fill="#fff" />
        <path
          d="m30.1 48c-1.9-0.5-3.8 0.6-4.3 2.5l8.2 2.1c0.9 0.2 1.9-0.3 2.1-1.2l0.4-1.7-6.4-1.7"
          fill="#666c70"
        />
        <path
          d="m48 28.4-13.8 5.8-3.5 13.9 5.8 1.5 3.4-11.2s5.6-2.4 7.1-3.6c1.3-1.1 2.9-3.6 1-6.4"
          fill="#231f20"
        />
        <path
          d="m48 28.4s-8.2-8.7-16.2-8.5l-6.1 4.8 0.5 5.5-4.8 2.6 1.6 2.9 5.8-3.1c0.7-0.4 0.9-1 0.9-1.9-0.1-0.7-0.2-2.8-0.2-2.8l6.6 5.8 11.9-5.3"
          fill="#3e4347"
        />
        <path
          d="m22.5 34.2-0.6-1.5c-0.2-0.5-0.9-0.8-1.4-0.5l-0.7 0.3c-0.5 0.1-0.8 0.5-0.8 0.9-1 0.5-2.1 1.4-1.3 3.2 0.1 0.3 0.8 1.9 2.8 1.1 2.9-1.3 2.9-1.3 2-3.5"
          fill="#666c70"
        />
        <path
          d="m37.3 13.5c0 6.3-1.8 6.1-11.5 11.5-3.2 1.8-7.7 1.8-9.8-5.6-0.7-2.4-1.6-3.2-1.6-5.8 0-6.5 5.1-11.6 11.5-11.6 6.3 0 11.4 5.1 11.4 11.5"
          fill="#ed4c5c"
        />
        <path
          d="m28.5 13.2c0.7 1.9-7.5 6.6-12.5 8.4-1.2 0.5-3.7-6.3-2.5-6.7 5-1.9 14.3-3.6 15-1.7"
          fill="#3e4347"
        />
...
export function Scuba(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      version="1.0"
      viewBox="0 0 24 24"
    ...
    >
      <defs>
        <linearGradient
          ...
          y1="562.14"
          y2="562.14"
          gradientTransform="matrix(.37756 0 0 .49943 -202.03 81.963)"
          gradientUnits="userSpaceOnUse"
        >
          <stop stopColor="#86b9c8" offset="0" />
          <stop stopColor="#a5c074" stopOpacity="0" offset="1" />
        </linearGradient>
      </defs>
      <g transform="translate(-41.434 -11.403)">
        <g transform="matrix(.47352 0 0 .62539 361.13 -173.11)">
          <g transform="matrix(.13671 -.0656 .10425 .15006 -621.62 219.63)">
            <g>
              <path
                d="m-423.49 386.93s23.626 22.182 37.516 27.8c0.63045 0.25501 2.3319 0.37014 2.3319 0.37014l37.293-20.002 1.8338 6.7612-35.249 21.662s-2.5696 2.5397-4.0476 2.4875c-1.4777-0.0522-4.5637-2.0505-4.5637-2.0505l-42.457-32.07z"
                fill="#272e56"
                fillRule="evenodd"
              />
              <circle
                transform="matrix(1.5172 0 0 1.5172 220.94 -204.42)"
                cx="-406.43"
                cy="374.51"
                r="20.714"
                fill="#f4d7d7"
              />
              <path
                d="m-425.29 374.93-73.638 19.928 8.3621 36.429s17.378-4.4704 23.939-7.2757c23.308-9.9651 52.342-35.939 52.342-35.939z"
                fill="#272e56"
                fillRule="evenodd"
              />
              <path
                d="m-489.81 431.08s-42.79 12.586-61.617 12.714c-12.993-2.3374-58.571-11.429-58.571-11.429l4.2857-12.287s53.256 8.0466 55.714 8.0012c2.6467-0.0488 37.143-12.857 37.143-12.857s-50.941 3.4778-55.714 2.8571-55.04-13.285-55.04-13.285l7.8172-11.288s44.005 8.6599 50.377 10.002c0.96716 0.20368 2.3062 0.41337 3.309 0.37725 11.21-0.41049 63.914-9.0914 63.914-9.0914z"
                fill="#272e56"
                fillRule="evenodd"
              />
              <ellipse
                transform="matrix(.90045 0 0 .91686 33.575 -77.393)"
                cx="-449.77"
                cy="478.34"
                rx="3.7881"
                ry="4.2931"
              ...
              />
              <path
                d="m-395.71 332.36c-17.349 0-31.437 14.089-31.438 31.438 0 17.349 14.089 31.406 31.438 31.406 4.9395 0 9.6212-1.123 13.781-3.1562-18.34-1.8731-32.344-11.895-32.344-23.969 0-13.406 17.271-24.281 38.562-24.281 1.4808 0 2.9374 0.0538 4.375 0.15625-5.7644-7.0745-14.545-11.594-24.375-11.594z"
                fill="#272e56"
              />
              <path
                d="m-401.06 352.84c3.2686-4.3164 7.3118-5.8867 14.927-5.7604 4.2896 0.0711 7.143-0.0223 10.752 0.0947 4.9347 0.16 9.2778-0.97285 12.387 3.0858 3.4187 3.8385 3.9208 12.509 2.859 18.566-0.78793 4.4953-2.9111 6.2241-6.128 7.0499-3.264 0.83785-3.5618 1.2191-6.4497-1.7538-1.4215-1.7762-3.5734-5.6983-5.966-4.6684-2.5527 1.2521-6.2376 5.5044-8.8024 6.7781-2.3717 1.4792-5.0128 2.0238-7.593 2.4045-4.159-0.17453-7.1549-5.2246-8.113-10.201-1.1049-5.2582-0.98753-11.483 2.1269-15.595z"
              ...
              />
              <path
                d="m-475.28 387.68c-2.3116 3.448 5.4289 36.746 10.076 37.83 6.8354 1.5936 29.246-17.245 29.246-17.245s-2.4586-19.043 0.0735-23.111c1.7778-2.8562 6.0861-4.5428 9.0914-3.0305 3.0895 1.5546 5.3673 11.958 5.3673 11.958s5.7081-2.3162 5.4279-4.0298c-1.0108-6.1819-2.9973-12.171-13.314-14.713s-44.513 10.17-45.969 12.341z"
                fill="#9b6f25"
                fillRule="evenodd"
              />
            </g>
            <g transform="matrix(.19236 .73326 -.83243 .16944 28.614 702.66)">
              <rect
                x="-539.37"
                y="494.11"
                width="50.577"
            ...
            <path
              d="m-619.7 387.08c3.2195 0.91596 4.4765 6.5716 4.4765 6.5716l-8.1262 11.162-9.0912-1.8855-41.42 22.679-21.77-26.653 57.316-4.0221s12.885-9.4816 18.615-7.8513z"
              fill="#202711"
              fillRule="evenodd"
            />
            <path
              d="m-611.43 415.22c3.3274-0.36441 6.4286 5.7143 6.4286 5.7143l-4.0995 11.624-10.186 3.3761-37.857 35-27.014-24.74 58.443-16.689s8.3634-13.637 14.286-14.286z"
              fill="#202711"
              fillRule="evenodd"
            />
            <g fill="#272e56" fillRule="evenodd">
              <path d="m-347 389.76c0.97598-3.056 3.165-3.6251 5.942-4.2663 1.2046-0.35822 4.195-0.51296 4.2627 1.8543-0.14664 1.0724-2.8668 1.7816-0.66182 2.0334 2.8185 0.67262 7.8955-3.4864 10.677-2.9657 1.6912 0.24454 2.9684 5.6878 1.8623 8.2828 0.41246 1.4714 1.7517 1.7753 0.86173 3.0709-0.84851 1.4476-2.5416 2.6872-3.4203 3.9791-2.0255 1.8483-4.6562 1.651-7.4008 2.3097-2.7642 0.22709-6.9415 0.11981-10.989-1.3833-2.2579-1.8123-1.1614-4.4316-1.7675-6.7254l0.0341-3.7523" />
              <path d="m-425.55 394.5-19.106 31.12 39.902-11.936 3.5553 8.1879-47.318 13.064s-7.4709 2.9601-9.659 1.4568c-2.713-1.864 1.2144-9.2003 1.2144-9.2003l22.23-37.167z" />
              <path d="m-403.76 403.25c2.2801-3.1984 4.4616-3.5218 7.1914-3.8442 1.2215-0.22708 3.9112 0.01 2.866 2.599-0.62868 1.1489-3.3404 1.5531-1.528 2.1265 2.1532 1.1153 7.5489-2.3453 9.7406-1.4006 1.3662 0.49586 0.93303 6.2177-1.2459 8.8959-0.32551 1.6596-0.55768 4.2997-1.9411 5.5911-1.4181 1.4627-2.6502 1.8828-4.022 3.1717-2.6352 1.7398-5.7057 1.5326-8.4153 1.8784-2.5254-0.1273-4.9734-1.4608-6.6912-3.8056-1.1307-2.2814 0.0638-5.97 0.60345-8.5522l1.7805-4.085" />
            </g>
            <path
              d="m-434.11 368.91c-34.375 46.61 47.116 23.567 54.531 21.183l-1.4286-1.4286"
              fill="none"
              stroke="#000"
              strokeLinecap="round"
              strokeLinejoin="round"
...
export function Electronics(props: SVGProps<SVGSVGElement>) {
  return (
...
export function Plane(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      <g transform="matrix(.003007 0 0 -.0047784 -.017946 18.008)">
        <path d="m2248 3755c-91-18-191-72-673-359-337-200-413-242-429-234-24 13-203-10-225-28-2-2 9-20 24-40 25-32 26-38 13-48-8-6-227-128-486-271s-469-263-466-266c2-4 25-9 51-12 37-4 61 1 108 20 114 48 450 201 674 307 181 86 227 104 236 94 7-7 108-141 226-298 193-258 212-288 211-321-2-27 8-54 45-113 38-63 44-79 33-86-33-18-96-73-107-93-7-12-12-42-13-66 0-96 89-187 237-241 81-29 94-31 168-26 64 5 89 12 128 36l48 30 42-29c41-28 101-90 164-168 18-23 61-62 95-88 35-26 61-50 58-54-6-8-2327-1260-2359-1272-20-8-22-14-17-41 3-18 10-36 14-40 13-13 173-50 196-46 11 3 643 292 1403 642l1382 638 486 86 100-19c417-80 825-156 1024-191l236-41 550-2 60 29c80 40 160 120 175 177 31 113-41 261-202 415-82 79-204 167-293 212-33 17-109 45-170 63-82 25-136 49-212 96-56 34-121 72-143 83-48 25-253 90-282 90-11 0-18 4-16 9s376 318 831 697c455 378 824 691 819 696-4 4-35 11-67 14-47 5-72 2-116-15-37-14-382-246-1019-686-892-616-966-665-1004-665-36 0-167 8-564 36-74 5-90 8-77 18 27 20 46 112 34 170-14 67-31 91-87 127-53 33-84 35-272 19-174-16-269-36-298-62-58-53-82-99-82-153 0-30-5-57-12-63-8-6-99-11-225-13l-212-3-198 185c-109 101-264 245-346 318l-147 134 43 31c25 17 259 177 520 356 262 179 477 328 477 333 0 9-10 8-92-8zm2242-1535c117-38 336-159 317-176-36-32-200-124-210-117-7 4-70 56-140 116l-128 110 30 31c17 18 31 40 31 49s1 17 3 17 45-14 97-30zm-77-235c106-88 126-110 115-120-7-7-110-76-229-153-210-135-217-139-246-127-65 28-105 248-72 393l12 50 50 6c28 3 87 23 132 44 65 32 83 37 95 27 8-7 73-61 143-120zm-1793-50c0-76-3-95-15-95-14 0-35 56-35 95s21 95 35 95c12 0 15-19 15-95zm130-15c0-79-3-100-14-100-24 0-40 91-26 150 7 30 17 50 26 50 11 0 14-21 14-100zm150-31c0-89-2-100-17-97-28 5-45 83-32 146 8 41 14 52 30 52 17 0 19-8 19-101zm140-20c0-90-2-100-17-97-11 2-23 20-32 47-18 58 0 151 30 151 17 0 19-8 19-101zm825 91c4-6 8-50 10-98s11-118 20-156 12-72 8-77c-10-10-114 9-132 24-21 18-11 255 12 290 18 28 69 38 82 17zm-675-110c0-92-2-100-19-100-12 0-23 11-30 31-24 68-6 169 30 169 17 0 19-8 19-100zm160-26c0-104 0-105-22-102-61 8-59 208 2 208 19 0 20-7 20-106zm180-23v-108l-24 4c-61 12-58 213 3 213 20 0 21-6 21-109z" />
      </g>
    </svg>
  )
}
export function Webpage(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      version="1.1"
      viewBox="0 0 24 24"
      ...
      {...props}
    >
      <g transform="matrix(.046875 0 0 .054205 0 -1.8766)">
        <path d="m472.18 34.62h-432.36c-21.958 0-39.822 17.864-39.822 39.822v363.12c0 21.958 17.864 39.822 39.822 39.822h432.36c21.958 0 39.822-17.864 39.822-39.822v-363.12c0-21.958-17.864-39.822-39.822-39.822zm5.689 402.94c0 3.137-2.552 5.689-5.689 5.689h-432.36c-3.137 0-5.689-2.552-5.689-5.689v-283.72h443.73v283.72zm0-317.85h-443.73v-45.263c0-3.137 2.552-5.689 5.689-5.689h432.36c3.137 0 5.689 2.552 5.689 5.689z" />
        ...
        <path d="m348.24 334.44c4.446 13.72 22.905 16.051 30.636 3.9l10.454-16.432 10.454 16.432c7.762 12.2 26.195 9.8 30.636-3.9l19.855-61.278c2.906-8.967-2.008-18.59-10.975-21.496-8.973-2.907-18.591 2.008-21.496 10.975l-8.681 26.79-5.392-8.478c-6.695-10.52-22.095-10.538-28.801 0l-5.393 8.478-8.681-26.791c-2.906-8.966-12.531-13.881-21.497-10.975-8.967 2.906-13.88 12.53-10.974 21.497z" />
      </g>
    </svg>
  )
}
