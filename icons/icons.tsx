...
export function Webpage(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      <g transform="scale(.065217)">
        <path d="m184 0c-101.6 0-184 82.4-184 184s82.4 184 184 184 184-82.4 184-184-82.4-184-184-184zm-42.8 21.6c-9.6 8.8-18.8 20.4-27.6 33.6-13.6 20.8-35.6 63.6-37.6 120.8h-60c3.6-74.4 55.6-136 125.2-154.4zm-124.8 170.4h60c2.4 66.4 33.2 124.8 65.6 154.8-70-18.4-122.4-80.4-125.6-154.8zm159.6 158.4c-31.6-10.4-80.8-77.2-84-158.4h84zm0-174.4h-84c3.2-81.2 52.4-148 84-158.4zm175.6 0h-59.6c-2.4-66.4-33.2-124.8-65.6-154.8 69.6 18.4 122 80.4 125.2 154.8zm-159.6-158.4c31.6 10.4 80.8 77.2 84 158.4h-84zm0 332.8v-158.4h84c-3.2 81.2-52.4 148-84 158.4zm34-3.6c32.4-30 63.6-88.4 66-154.8h60c-3.6 74.4-56 136.4-126 154.8z" />
      </g>
    </svg>
  )
}
